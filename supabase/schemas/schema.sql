...
-- Manual name alias mappings for Zoom attendance matching
...
COMMENT ON TABLE member_name_aliases IS 'Bronze: Manual name mappings for Zoom attendance matching (nicknames, variations, etc.)';
