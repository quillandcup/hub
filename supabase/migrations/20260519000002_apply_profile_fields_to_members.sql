-- Re-applies profile field changes from 20260519000001, which was marked
-- as applied before the SQL executed. Uses IF NOT EXISTS / OR REPLACE so
-- it is safe to run on databases that already have the columns.
