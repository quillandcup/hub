CREATE OR REPLACE FUNCTION public.reprocess_prickle_attendance_atomic(from_date timestamp with time zone, to_date timestamp with time zone, new_pup_data jsonb, new_attendance_data jsonb)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN
