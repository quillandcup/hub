...
curl https://hub.quillandcup.com/api/reconcile/calendar \
  -H "Authorization: Bearer $TOKEN"

# Zoom reconciliation
curl https://hub.quillandcup.com/api/reconcile/zoom \
  -H "Authorization: Bearer $TOKEN"

# Members reconciliation
curl https://hub.quillandcup.com/api/reconcile/members \
  -H "Authorization: Bearer $TOKEN"
```
